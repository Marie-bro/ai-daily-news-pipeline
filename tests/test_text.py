...
class TextTests(unittest.TestCase):
    ...
    def test_release_burst_keeps_only_newest_same_day_series(self):
        base = dict(category="ai", title="Release v1.2.3 · org/sdk", original_title="Release", source="Official SDK", source_type="github_release", language="en", raw_text="raw" * 100, clean_text="clean" * 100, fingerprint="a", created_at="2026-09-14T00:00:00+00:00", verification_status="source_verified")
        older = Article(id="a", published_at="2026-09-14T01:00:00+00:00", original_url="https://example.com/1", **base)
        newer = Article(id="b", title="Release v1.2.4 · org/sdk", published_at="2026-09-14T02:00:00+00:00", original_url="https://example.com/2", fingerprint="b", **{key: value for key, value in base.items() if key not in {"title", "fingerprint"}})
