...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Create a concise, source-grounded Tech Daily using one DeepSeek batch.")
    ...
    except (EnrichmentError, DeepSeekError) as exc:
    ...
    print(
        ...
        f"cache_miss={usage.get('prompt_cache_miss_tokens', '-')} output={result.output_path or '-'}"
    )
